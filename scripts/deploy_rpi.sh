...
ARUCO_INTERVAL_SEC="${ARUCO_INTERVAL_SEC:-0.5}"
...
ARUCO_MARKER_SIZE_CM="${ARUCO_MARKER_SIZE_CM:-15.0}"
ARUCO_OVERLAY_FLIP_X="${ARUCO_OVERLAY_FLIP_X:-false}"
...
ROOMBA_PLAYER_ARUCO_MARKER_SIZE_CM=${ARUCO_MARKER_SIZE_CM}
ROOMBA_PLAYER_ARUCO_OVERLAY_FLIP_X=${ARUCO_OVERLAY_FLIP_X}
